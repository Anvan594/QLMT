...
def seed(conn):
    ...
    def mk(code, dept, pos, model, serial, import_date, warranty_months):
        ...
        conn.execute('INSERT INTO devices(id,asset_code,dept_id,pos_id,group_id,type_id,model,manufacturer,\n            serial,config,status,import_date,allocate_date,warranty_months,warranty_unit,supplier,value,note,created_at,\n            computer_name,mainboard,cpu,ram,gpu,storage,os_name,win_key_bios,win_key_current,system_model,\n            serial_number,mac_physical,mac_virtual)\n            VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', (new_id(), code, did, pid, cntt_id, maytinh_id, model, maker, serial, '', 'Bình thường', import_date, '', warranty_months, 'Tháng', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',
    mk('MT-260004', 'Kho', 'Kho', 'HP 205 Pro G4 22 All-in-One', '8CC1021HGGX1', '2026-07-20', '')
    mk('MT-260003', 'Văn phòng', 'Kế Toán', 'HP 205 Pro G4 22 All-in-One', '8CC1021HGG2', '2026-06-29', '1')
    mk('MT-260002', 'Văn phòng', 'Nhân sự', 'Latitude 7490', '97BQRQ2SD', '2025-07-19', '12')
    mk('MT-260001', 'Xưởng', 'Xưởng', 'Latitude 7490', '97BQRQ2', '2026-06-19', '24')
...
def parse_xlsx_first_sheet(file_bytes):
    ...
    """Đọc sheet đầu tiên của file .xlsx, trả về list các dòng (mỗi dòng là\nlist chuỗi). Hỗ trợ cả ô dạng inlineStr lẫn sharedStrings (Excel/LibreOffice\n/Google Sheets đều xuất ra được các dạng này) — chỉ dùng zipfile + xml.etree\ncó sẵn trong Python, không cần cài thêm thư viện nào."""
...
def device_to_dict(r):
    keys = r.keys()
    return {'id': r['id'], 'assetCode': r['asset_code'], 'deptId': r['dept_id'], 'posId': r['pos_id'], 'groupId': r['group_id'], 'typeId': r['type_id'], 'model': r['model'] or '', '': r[''] or '', '': r[''] or '', '': r[''] or '', '': r[''] or '', 'manufacturer': r['manufacturer'] or '', 'serial': r['serial'] or '', 'config': r['config'] or '', 'status': r['status'] or '', 'Bình thường': r['Bình thường'
...
def get_bootstrap(conn, account=None):
    ...
    if has_permission(conn, account, 'logs', 'view'):
        ...
        logs = []
    return {'departments': departments, 'groups': groups, 'devices': devices, 'history': history, 'counters': counters, 'company': company, 'users': users, 'suppliers': suppliers, 'materials': material_txns, 'accounts': accounts, 'permissions': permissions, 'logs': logs, 'maintenance': maintenance, 'branches': branches, 'borrows': borrows, 'p': p, 'r': r, 't': t, '<code object ensure_warehouse_location at 0x73ab24cf5430, file \"server.py\", line 477>': <code object ensure_warehouse_location at 0x73ab24cf5430, file "server.py", line 477>, '<code object init_db at 0x73a9c160b5a0, file \"server.py\", line 492>': <code object init_db at 0x73a9c160b5a0, file "server.py", line 492>, '<code object seed at 0x5f89ca50, file \"server.py\", line 504>': <code object seed at 0x5f89ca50, file "server.py", line 504>, '<code object new_id at 0x73ab1bf55a70, file \"server.py\", line 559>': <code object new_id at 0x73ab1bf55a70, file "server.py", line 559>, '<code object now_ms at 0x73a9f857fe10, file \"server.py\", line 562>': <code object now_ms at 0x73a9f857fe10, file "server.py", line 562>, '<code object next_counter at 0x73aa1933bcf0, file \"server.py\", line 565>': <code object next_counter at 0x73aa1933bcf0, file "server.py", line 565>, '<code object initials at 0x73ab24cf6d30, file \"server.py\", line 574>': <code object initials at 0x73ab24cf6d30, file "server.py", line 574>, '<code object gen_asset_code at 0x73aa1933a0d0, file \"server.py\", line 579>': <code object gen_asset_code at 0x73aa1933a0d0, file "server.py", line 579>, '<code object gen_doc_code at 0x73a9c1608880, file \"server.py\", line 586>': <code object gen_doc_code at 0x73a9c1608880, file "server.py", line 586>, '<code object gen_material_code at 0x73a9c160ad50, file \"server.py\", line 593>': <code object gen_material_code at 0x73a9c160ad50, file "server.py", line 593>, '<code object gen_material_item_code at 0x73aad98bfcc0, file \"server.py\", line 600>': <code object gen_material_item_code at 0x73aad98bfcc0, file "server.py", line 600>, '<code object gen_maintenance_code at 0x73aad98bfdd0, file \"server.py\", line 605>': <code object gen_maintenance_code at 0x73aad98bfdd0, file "server.py", line 605>, '<code object gen_borrow_code at 0x73aad98bc360, file \"server.py\", line 610>': <code object gen_borrow_code at 0x73aad98bc360, file "server.py", line 610>, 'Cần bảo trì': Cần bảo trì, 'Hỏng - chờ sửa': Hỏng - chờ sửa,
ROUTES = []
...
def guard(module, required='view'):
    """Decorator gắn cho route API: từ chối truy cập (403) nếu tài khoản hiện\ntại không đủ quyền trên module tương ứng. Đặt SAU @route (chạy trước khi\nvào hàm xử lý thật sự)."""
    def deco(fn):
        def wrapped(m, body, qs):
            # irreducible cflow, using cdg fallback
            conn = get_db()
            if not has_permission(conn, current_account(), module, required):
                @err('Bạn không có quyền thực hiện thao tác này. Vui lòng liên hệ quản trị viên.', 403)
                    conn.close()
                return fn(m, body, qs)
...
def r_export_xlsx(m, body, qs):
    ...
    if module and (not has_permission(conn, current_account(), module, 'view')):
        @err('Bạn không có quyền xuất dữ liệu mục này.', 403)
            conn.close()
        conn.close()
        ...
        if not isinstance(columns, list) or not columns:
            ...
            if not isinstance(rows_in, list):
                ...
                data_rows = ['' if row.get(c) is None else row.get(c) for row in rows_in]
...
def r_system_info(m, body, qs):
    ...
    if info_type == 'specs':
        ps_script = '\n$ErrorActionPreference = \"SilentlyContinue\"\n$cs    = Get-CimInstance Win32_ComputerSystem\n$bios  = Get-CimInstance Win32_BIOS\n$os    = Get-CimInstance Win32_OperatingSystem\n$cpu   = Get-CimInstance Win32_Processor | Select-Object -First 1\n$gpu   = Get-CimInstance Win32_VideoController | Select-Object -First 1\n$board = Get-CimInstance Win32_BaseBoard\n$disks = Get-CimInstance Win32_DiskDrive | ForEach-Object { \"$($_.Model) ($([math]::Round($_.Size/1GB))GB)\" }\n$macPhys = Get-CimInstance Win32_NetworkAdapter -Filter \"PhysicalAdapter=True AND MACAddress IS NOT NULL\" | Select-Object -First 1 -ExpandProperty MACAddress\n$macVirt = Get-CimInstance Win32_NetworkAdapter -Filter \"PhysicalAdapter=False AND MACAddress IS NOT NULL\" | Select-Object -First 1 -ExpandProperty MACAddress\n$oa3 = (Get-CimInstance -Query \"SELECT * FROM SoftwareLicensingService\").OA3xOriginalProductKey\n$partialKey = (Get-CimInstance SoftwareLicensingProduct -Filter \"ApplicationID=\'55c92734-d682-4d71-983e-d6ec3f16059f\' AND PartialProductKey IS NOT NULL\" | Select-Object -First 1).PartialProductKey\n\nfunction Get-FullProductKeyFromRegistry {\n    try {\n        $regPath = \"HKLM:\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\"\n        $binArr = (Get-ItemProperty -Path $regPath -Name DigitalProductId -ErrorAction Stop).DigitalProductId\n        if (-not $binArr) { return \"\" }\n        $keyOffset = 52\n        $isWin8 = [math]::Floor($binArr[66] / 6) -band 1\n        $binArr[66] = ($binArr[66] -band 0xF7) -bor (($isWin8 -band 2) * 4)\n        $chars = \"BCDFGHJKMPQRTVWXY2346789\"\n        $last = 0\n        $key = \"\"\n        for ($i = 24; $i -ge 0; $i--) {\n            $current = 0\n            for ($j = 14; $j -ge 0; $j--) {\n                $current = $current * 256 -bxor $binArr[$j + $keyOffset]\n                $binArr[$j + $keyOffset] = [math]::Floor($current / 24)\n                $current = $current % 24\n            }\n            $key = $chars[$current] + $key\n            $last = $current\n        }\n        if ($isWin8 -eq 1) {\n            $keypart1 = $key.Substring(1, $last)\n            $insert = \"N\"\n            $key = $key.Insert($key.IndexOf($keypart1) + $keypart1.Length, $insert)\n            if ($last -eq 0) { $key = $insert + $key }\n        }\n        return $key.Insert(5,\"-\").Insert(11,\"-\").Insert(17,\"-\").Insert(23,\"-\")\n    } catch { return \"\" }\n}\n$winKeyFull = Get-FullProductKeyFromRegistry\n\n$result = [ordered]@{\n    computerName   = $env:COMPUTERNAME\n    mainboard      = ((\"$($board.Manufacturer) $($board.Product)\").Trim())\n    cpu            = $cpu.Name\n    ram            = \"$([math]::Round($cs.TotalPhysicalMemory/1GB)) GB\"\n    gpu            = $gpu.Name\n    storage        = ($disks -join \"; \")\n    osName         = $os.Caption\n    winKeyBios     = $oa3\n    winKeyCurrent  = $winKeyFull\n    winKeyPartial  = $partialKey\n    systemModel    = $cs.Model\n    serialNumber   = $bios.SerialNumber\n    macPhysical    = $macPhys\n    macVirtual     = $macVirt\n    model          = $cs.Model\n    manufacturer   = $cs.Manufacturer\n    serial         = $bios.SerialNumber\n}\n$result | ConvertTo-Json -Compress\n'
        output = run_powershell(ps_script, timeout=25)
        data = json.loads(output.strip())
        for k, v in list(data.items()):
            data[k] = (v or '').strip() if isinstance(v, str) else v or ''
        if not data.get('winKeyCurrent') and data.get('winKeyPartial'):
                data['winKeyCurrent'] = 'XXXXX-XXXXX-XXXXX-XXXXX-' + data['winKeyPartial'] + '  (không đọc được key đầy đủ - máy dùng Digital License)'
        return (200, data)
        if info_type == 'monitors':
            ps_script = '\n$ErrorActionPreference = \"SilentlyContinue\"\n$monitors = Get-CimInstance -Namespace root\\wmi -ClassName WmiMonitorID\n$results = @()\nif ($monitors) {\n    foreach ($m in $monitors) {\n        $name = [System.Text.Encoding]::ASCII.GetString($m.UserFriendlyName).Trim([char]0)\n        $mfg  = [System.Text.Encoding]::ASCII.GetString($m.ManufacturerName).Trim([char]0)\n        $ser  = [System.Text.Encoding]::ASCII.GetString($m.SerialNumberID).Trim([char]0)\n        if (-not $name) { $name = \"Màn hình\" }\n        if (-not $mfg)  { $mfg  = \"\" }\n        if (-not $ser)  { $ser  = \"\" }\n        $results += [PSCustomObject]@{ Name = $name; Manufacturer = $mfg; Serial = $ser }\n    }\n} else {\n    $dm = Get-CimInstance Win32_DesktopMonitor\n    foreach ($d in $dm) {\n        $results += [PSCustomObject]@{ Name = $d.Name; Manufacturer = $d.MonitorManufacturer; Serial = \"\" }\n    }\n}\n$results | ConvertTo-Json -Compress\n'
            output = run_powershell(ps_script, timeout=20)
            monitors_list = []
            try:
                data = json.loads(output.strip())
                if isinstance(data, dict):
                    data = [data]
                for m in data:
                    monitors_list.append({'name': m.get('Name') or 'Màn hình', 'manufacturer': m.get('Manufacturer') or '', 'serial': m.get('Serial') or ''})
            except Exception:
                pass
            return (200, {'monitors': monitors_list})
            if info_type == 'printers':
                ps_script = '\n$ErrorActionPreference = \"SilentlyContinue\"\n$printers = Get-CimInstance Win32_Printer\n$results = @()\nforeach ($p in $printers) {\n    $serial = $p.PortName\n    if (-not $serial) { $serial = \"\" }\n    $results += [PSCustomObject]@{ Name = $p.Name; Manufacturer = $p.DriverName; Serial = $serial; IsDefault = [bool]$p.Default }\n}\n$results | ConvertTo-Json -Compress\n'
                output = run_powershell(ps_script, timeout=20)
                printers_list = []
                try:
                    data = json.loads(output.strip())
                    if isinstance(data, dict):
                        data = [data]
                    for p in data:
                        printers_list.append({'name': p.get('Name') or 'Máy in', 'manufacturer': p.get('Manufacturer') or '', 'serial': p.get('Serial') or '', 'isDefault': bool(p.get('IsDefault'))})
                except Exception:
                    pass
                return (200, {'printers': printers_list})
                if info_type == 'license':
                    ps_script = '\n$ErrorActionPreference = \"SilentlyContinue\"\n$os  = Get-CimInstance Win32_OperatingSystem\n$lic = Get-CimInstance SoftwareLicensingProduct -Filter \"ApplicationID=\'55c92734-d682-4d71-983e-d6ec3f16059f\' AND PartialProductKey IS NOT NULL\" | Select-Object -First 1\n\n$statusMap = @{0=\"Chưa kích hoạt\";1=\"Đã kích hoạt (Licensed)\";2=\"Bản dùng thử - Grace\";3=\"Hết hạn - OOT Grace\";4=\"Không xác định - Non-Genuine\";5=\"Notification\";6=\"Extended Grace\"}\n$statusVal = if ($lic) { [int]$lic.LicenseStatus } else { -1 }\n$statusText = if ($statusMap.ContainsKey($statusVal)) { $statusMap[$statusVal] } else { \"Không xác định\" }\n\nfunction Get-FullProductKeyFromRegistry {\n    try {\n        $regPath = \"HKLM:\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\"\n        $binArr = (Get-ItemProperty -Path $regPath -Name DigitalProductId -ErrorAction Stop).DigitalProductId\n        if (-not $binArr) { return \"\" }\n        $keyOffset = 52\n        $isWin8 = [math]::Floor($binArr[66] / 6) -band 1\n        $binArr[66] = ($binArr[66] -band 0xF7) -bor (($isWin8 -band 2) * 4)\n        $chars = \"BCDFGHJKMPQRTVWXY2346789\"\n        $last = 0\n        $key = \"\"\n        for ($i = 24; $i -ge 0; $i--) {\n            $current = 0\n            for ($j = 14; $j -ge 0; $j--) {\n                $current = $current * 256 -bxor $binArr[$j + $keyOffset]\n                $binArr[$j + $keyOffset] = [math]::Floor($current / 24)\n                $current = $current % 24\n            }\n            $key = $chars[$current] + $key\n            $last = $current\n        }\n        if ($isWin8 -eq 1) {\n            $keypart1 = $key.Substring(1, $last)\n            $insert = \"N\"\n            $key = $key.Insert($key.IndexOf($keypart1) + $keypart1.Length, $insert)\n            if ($last -eq 0) { $key = $insert + $key }\n        }\n        return $key.Insert(5,\"-\").Insert(11,\"-\").Insert(17,\"-\").Insert(23,\"-\")\n    } catch {\n        return \"\"\n    }\n}\n\n$result = [ordered]@{\n    computerName      = $env:COMPUTERNAME\n    osName            = $os.Caption\n    osVersion         = $os.Version\n    edition           = $lic.Name\n    partialKey        = $lic.PartialProductKey\n    fullKeyRegistry   = Get-FullProductKeyFromRegistry\n    licenseStatusCode = $statusVal\n    licenseStatus     = $statusText\n}\n$result | ConvertTo-Json -Compress\n'
                    output = run_powershell(ps_script, timeout=20)
                    data = json.loads(output.strip())
                    for k, v in list(data.items()):
                        if isinstance(v, str):
                            data[k] = v.strip()
                    return (200, data)
                    if info_type == 'windowsdeepscan':
                        ps_script = '\n$ErrorActionPreference = \"SilentlyContinue\"\n\n$lic = Get-CimInstance SoftwareLicensingProduct -Filter \"ApplicationID=\'55c92734-d682-4d71-983e-d6ec3f16059f\' AND PartialProductKey IS NOT NULL\" | Select-Object -First 1\n$svc = Get-CimInstance SoftwareLicensingService | Select-Object -First 1\n\n# --- 1) Máy chủ KMS đang kết nối (nếu kênh kích hoạt là Volume/KMS) ---\n$kmsServerMachine = $lic.KeyManagementServiceMachine\n$kmsServerPort    = $lic.KeyManagementServicePort\n$productKeyChannel = $lic.ProductKeyChannel\n$kmsIsPrivateNetwork = $false\nif ($kmsServerMachine) {\n    $ipToCheck = $kmsServerMachine\n    if ($kmsServerMachine -notmatch \'^\\d{1,3}(\\.\\d{1,3}){3}$\') {\n        try { $resolved = [System.Net.Dns]::GetHostAddresses($kmsServerMachine) | Select-Object -First 1; if ($resolved) { $ipToCheck = $resolved.ToString() } } catch {}\n    }\n    if ($ipToCheck -match \'^(10\\.|192\\.168\\.|172\\.(1[6-9]|2[0-9]|3[0-1])\\.|127\\.)\') { $kmsIsPrivateNetwork = $true }\n}\n\n# --- 2) Dấu vết lệnh kích hoạt trái phép trong lịch sử PowerShell của user hiện tại ---\n$masTraceFound = $false\n$masTraceLines = @()\n$histPath = \"$env:APPDATA\\Microsoft\\Windows\\PowerShell\\PSReadLine\\ConsoleHost_history.txt\"\nif (Test-Path $histPath) {\n    try {\n        $lines = Get-Content $histPath -ErrorAction SilentlyContinue\n        $matches_ = $lines | Where-Object { $_ -match \'massgrave|mas\\.dev|Microsoft-Activation-Scripts|MAS_AIO|HWIDGen|KMS38|irm.*\\.ps1.*iex\' }\n        if ($matches_) { $masTraceFound = $true; $masTraceLines = @($matches_ | Select-Object -First 5) }\n    } catch {}\n}\n\n# --- 3) Dấu hiệu kỹ thuật KMS38 (ngày hết hạn hiển thị quanh năm 2038) ---\n$kms38Suspected = $false\ntry {\n    $xprOut = cscript //nologo \"$env:WINDIR\\System32\\slmgr.vbs\" /xpr 2>$null\n    if ($xprOut -match \'2038\') { $kms38Suspected = $true }\n} catch {}\n\n# --- 4) Key OEM gắn trong BIOS/mainboard (máy tự ráp thường KHÔNG có) ---\n$hasBiosOemKey = [bool]($svc.OA3xOriginalProductKey -and $svc.OA3xOriginalProductKey.Trim() -ne \"\")\n\n# --- 5) Thư mục công cụ kích hoạt trái phép phổ biến ---\n$suspiciousFolderCandidates = @(\n    \"$env:WINDIR\\KMS\", \"$env:WINDIR\\AutoKMS\", \"$env:ProgramData\\KMSAutoS\", \"$env:ProgramData\\KMSpico\",\n    \"$env:ProgramData\\Microsoft-Activation-Scripts\", \"C:\\KMS_VL_ALL\", \"C:\\Windows\\Temp\\KMS\"\n)\n$foundFolders = @($suspiciousFolderCandidates | Where-Object { Test-Path $_ })\n\n# --- 6) Scheduled Task tự động gia hạn kích hoạt trái phép ---\n$foundTasks = @()\ntry {\n    $schOut = schtasks /query /fo CSV /nh 2>$null\n    foreach ($line in $schOut) {\n        if ($line -match \'autokms|kmsautonet|autopico|kmseldi|kms38|hwidgen|kmspico\') {\n            $foundTasks += ($line -split \',\')[0].Trim(\'\"\')\n        }\n    }\n} catch {}\n$foundTasks = @($foundTasks | Select-Object -Unique)\n\n# --- 7) Registry policy NoGenTicket ---\n$noGenTicketPolicy = $false\ntry {\n    $v = Get-ItemProperty -Path \"HKLM:\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\SoftwareProtectionPlatform\" -Name \"NoGenTicket\" -ErrorAction Stop\n    if ($v.NoGenTicket -eq 1) { $noGenTicketPolicy = $true }\n} catch {}\n\n$result = [ordered]@{\n    kmsServerMachine     = $kmsServerMachine\n    kmsServerPort        = $kmsServerPort\n    productKeyChannel    = $productKeyChannel\n    kmsIsPrivateNetwork  = $kmsIsPrivateNetwork\n    masTraceFound        = $masTraceFound\n    masTraceLines        = $masTraceLines\n    kms38Suspected       = $kms38Suspected\n    hasBiosOemKey        = $hasBiosOemKey\n    suspiciousFolders    = $foundFolders\n    suspiciousTasks      = $foundTasks\n    noGenTicketPolicy    = $noGenTicketPolicy\n}\n$result | ConvertTo-Json -Compress -Depth 6\n'
                        output = run_powershell(ps_script, timeout=30)
                        data = strip_deep(json.loads(output.strip()))
                        data['verdict'] = compute_windows_verdict(data)
                        return (200, data)
                        if info_type == 'licensescan':
                            ps_script = '\n$ErrorActionPreference = \"SilentlyContinue\"\n\nfunction Get-FullProductKeyFromRegistry {\n    try {\n        $regPath = \"HKLM:\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\"\n        $binArr = (Get-ItemProperty -Path $regPath -Name DigitalProductId -ErrorAction Stop).DigitalProductId\n        if (-not $binArr) { return \"\" }\n        $keyOffset = 52\n        $isWin8 = [math]::Floor($binArr[66] / 6) -band 1\n        $binArr[66] = ($binArr[66] -band 0xF7) -bor (($isWin8 -band 2) * 4)\n        $chars = \"BCDFGHJKMPQRTVWXY2346789\"\n        $last = 0\n        $key = \"\"\n        for ($i = 24; $i -ge 0; $i--) {\n            $current = 0\n            for ($j = 14; $j -ge 0; $j--) {\n                $current = $current * 256 -bxor $binArr[$j + $keyOffset]\n                $binArr[$j + $keyOffset] = [math]::Floor($current / 24)\n                $current = $current % 24\n            }\n            $key = $chars[$current] + $key\n            $last = $current\n        }\n        if ($isWin8 -eq 1) {\n            $keypart1 = $key.Substring(1, $last)\n            $insert = \"N\"\n            $key = $key.Insert($key.IndexOf($keypart1) + $keypart1.Length, $insert)\n            if ($last -eq 0) { $key = $insert + $key }\n        }\n        return $key.Insert(5,\"-\").Insert(11,\"-\").Insert(17,\"-\").Insert(23,\"-\")\n    } catch { return \"\" }\n}\n$winKeyFull = Get-FullProductKeyFromRegistry\n\n# --- Deep registry scan of installed software (same source as \"Apps & Features\") ---\n$uninstallPaths = @(\n    \"HKLM:\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\*\",\n    \"HKLM:\\SOFTWARE\\WOW6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\*\",\n    \"HKCU:\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\*\"\n)\n$installed = Get-ItemProperty -Path $uninstallPaths -ErrorAction SilentlyContinue |\n    Where-Object { $_.DisplayName -and $_.DisplayName.Trim() -ne \"\" } |\n    Select-Object DisplayName, DisplayVersion, Publisher, InstallDate -Unique\n\nfunction Find-First($pattern) {\n    $m = $installed | Where-Object { $_.DisplayName -match $pattern } | Select-Object -First 1\n    if (-not $m) { return $null }\n    return [ordered]@{ name = $m.DisplayName; version = $m.DisplayVersion; publisher = $m.Publisher; installDate = $m.InstallDate }\n}\nfunction Find-All($pattern) {\n    $ms = $installed | Where-Object { $_.DisplayName -match $pattern }\n    return @($ms | ForEach-Object { [ordered]@{ name = $_.DisplayName; version = $_.DisplayVersion; publisher = $_.Publisher; installDate = $_.InstallDate } })\n}\n\n$officeApp    = Find-First \'Microsoft 365|Microsoft Office\'\n$winrarApp    = Find-First \'^WinRAR\'\n$idmApp       = Find-First \'Internet Download Manager\'\n$adobeApps    = Find-All \'Adobe\'\n$autodeskApps = Find-All \'Autodesk\'\n$corelApps    = Find-All \'CorelDRAW|Corel PHOTO-PAINT|Corel PaintShop|Corel Painter|Corel Website Creator|Corel VideoStudio|Corel PDF Fusion|^Corel \'\n\n# --- Dò từng phần mềm cụ thể theo yêu cầu (kiểm tra sâu, riêng từng ứng dụng) ---\n$photoshopApp    = Find-First \'Adobe Photoshop(?!.*Elements)\'\n$illustratorApp  = Find-First \'Adobe Illustrator\'\n$lightroomApp    = Find-First \'Adobe Lightroom\'\n$premiereApp     = Find-First \'Adobe Premiere Pro\'\n$afterEffectsApp = Find-First \'Adobe After Effects\'\n$coreldrawApp    = Find-First \'CorelDRAW\'\n$canvaApp        = Find-First \'Canva\'\n$camtasiaApp     = Find-First \'Camtasia\'\n$filmoraApp      = Find-First \'Filmora\'\n\n# Adobe Creative Cloud (Photoshop/Illustrator/Lightroom/Premiere Pro/After Effects) dùng\n# license đám mây gắn tài khoản, không lưu product key cục bộ. Ta chỉ kiểm tra sự tồn tại\n# của kho license cục bộ của Adobe (SLStore) để biết máy có hạ tầng cấp phép Adobe hay không -\n# đây KHÔNG phải là cách đọc ra key hay xác nhận tài khoản có trả phí hay không.\n$adobeSLStore = (Test-Path \"$env:ProgramData\\Adobe\\SLStore\") -or (Test-Path \"$env:ProgramData\\Adobe\\OOBE\")\n\n# Camtasia (TechSmith): chỉ kiểm tra SỰ TỒN TẠI của mục đăng ký license trong registry,\n# không đọc giá trị license/serial thực tế.\n$camtasiaRegistered = $false\ntry {\n    $tsPaths = @(\"HKCU:\\Software\\TechSmith\\*\",\"HKLM:\\SOFTWARE\\TechSmith\\*\",\"HKLM:\\SOFTWARE\\WOW6432Node\\TechSmith\\*\")\n    foreach ($p in $tsPaths) {\n        $items = Get-ItemProperty -Path $p -ErrorAction SilentlyContinue\n        foreach ($it in $items) {\n            $names = $it.PSObject.Properties.Name\n            if (($names -contains \"LicenseKey\") -or ($names -contains \"SerialNumber\") -or ($names -contains \"License\")) {\n                $camtasiaRegistered = $true\n            }\n        }\n    }\n} catch {}\n\n# Filmora (Wondershare): tương tự, chỉ kiểm tra sự tồn tại của mục đăng ký, không đọc giá trị.\n$filmoraRegistered = $false\ntry {\n    $wsPaths = @(\"HKCU:\\Software\\Wondershare\\*\",\"HKLM:\\SOFTWARE\\Wondershare\\*\",\"HKLM:\\SOFTWARE\\WOW6432Node\\Wondershare\\*\")\n    foreach ($p in $wsPaths) {\n        $items = Get-ItemProperty -Path $p -ErrorAction SilentlyContinue\n        foreach ($it in $items) {\n            $names = $it.PSObject.Properties.Name\n            if (($names -contains \"RegCode\") -or ($names -contains \"ActivationCode\") -or ($names -contains \"Serial\") -or ($names -contains \"LicenseKey\")) {\n                $filmoraRegistered = $true\n            }\n        }\n    }\n} catch {}\n\n# Office activation - official ospp.vbs /dstatus tool (last-5-chars key only)\n$officeKeyLast5 = \"\"\n$osppPaths = @(\n    \"$env:ProgramFiles\\Microsoft Office\\Office16\\ospp.vbs\",\n    \"${env:ProgramFiles(x86)}\\Microsoft Office\\Office16\\ospp.vbs\",\n    \"$env:ProgramFiles\\Microsoft Office\\Office15\\ospp.vbs\",\n    \"${env:ProgramFiles(x86)}\\Microsoft Office\\Office15\\ospp.vbs\"\n)\n$osppPath = $osppPaths | Where-Object { Test-Path $_ } | Select-Object -First 1\n$officeLicStatus = \"\"\nif ($osppPath) {\n    $osppOut = cscript //nologo \"$osppPath\" /dstatus 2>$null\n    $line = $osppOut | Select-String \"Last 5 characters of installed product key\"\n    if ($line) { $officeKeyLast5 = ($line.ToString() -split \":\\s*\")[-1].Trim() }\n    $statusLine = $osppOut | Select-String \"LICENSE STATUS\"\n    if ($statusLine) { $officeLicStatus = $statusLine.ToString().Trim() }\n}\n\n$winrarRegTo = \"\"\n$rarPaths = @(\n    \"$env:APPDATA\\WinRAR\\rarreg.key\",\n    \"$env:ProgramFiles\\WinRAR\\rarreg.key\",\n    \"${env:ProgramFiles(x86)}\\WinRAR\\rarreg.key\"\n)\n$rarPath = $rarPaths | Where-Object { Test-Path $_ } | Select-Object -First 1\nif ($rarPath) {\n    $rarLines = Get-Content $rarPath -ErrorAction SilentlyContinue | Select-Object -First 2\n    if ($rarLines) { $winrarRegTo = ($rarLines -join \' \').Trim() }\n}\n\n$idmRegistered = $false\ntry {\n    $idmKey = Get-ItemProperty -Path \"HKCU:\\Software\\DownloadManager\" -ErrorAction Stop\n    if (($idmKey.PSObject.Properties.Name -contains \"Serial\") -or ($idmKey.PSObject.Properties.Name -contains \"LName\")) {\n        $idmRegistered = $true\n    }\n} catch {}\n\n# CorelDRAW: newer versions (2017+) activate via cloud Corel Account (no local key, same as\n# Adobe/Autodesk). Older versions can store a registration entry locally - we only report\n# whether such an entry exists, we do not extract or decode the serial itself.\n$corelRegistered = $false\n$corelRegPaths = @(\n    \"HKCU:\\SOFTWARE\\Corel\\CorelDRAW\\*\",\n    \"HKLM:\\SOFTWARE\\Corel\\CorelDRAW\\*\",\n    \"HKLM:\\SOFTWARE\\WOW6432Node\\Corel\\CorelDRAW\\*\",\n    \"HKCU:\\SOFTWARE\\Corel\\Products\\*\",\n    \"HKLM:\\SOFTWARE\\Corel\\Products\\*\",\n    \"HKLM:\\SOFTWARE\\WOW6432Node\\Corel\\Products\\*\"\n)\nforeach ($p in $corelRegPaths) {\n    try {\n        $items = Get-ItemProperty -Path $p -ErrorAction SilentlyContinue\n        foreach ($it in $items) {\n            $names = $it.PSObject.Properties.Name\n            if (($names -contains \"Serial\") -or ($names -contains \"SerialNumber\") -or ($names -contains \"Serial Number\") -or ($names -contains \"LicenseNumber\")) {\n                $corelRegistered = $true\n            }\n        }\n    } catch {}\n}\n\n$result = [ordered]@{\n    winKeyFull       = $winKeyFull\n    officeKeyLast5   = $officeKeyLast5\n    officeLicStatus  = $officeLicStatus\n    winrarRegTo      = $winrarRegTo\n    idmRegistered    = $idmRegistered\n    corelRegistered  = $corelRegistered\n    officeApp        = $officeApp\n    winrarApp        = $winrarApp\n    idmApp           = $idmApp\n    adobeApps        = $adobeApps\n    autodeskApps     = $autodeskApps\n    corelApps        = $corelApps\n    photoshopApp        = $photoshopApp\n    illustratorApp      = $illustratorApp\n    lightroomApp        = $lightroomApp\n    premiereApp         = $premiereApp\n    afterEffectsApp     = $afterEffectsApp\n    coreldrawApp        = $coreldrawApp\n    canvaApp            = $canvaApp\n    camtasiaApp         = $camtasiaApp\n    filmoraApp          = $filmoraApp\n    adobeSLStore        = $adobeSLStore\n    camtasiaRegistered  = $camtasiaRegistered\n    filmoraRegistered   = $filmoraRegistered\n}\n$result | ConvertTo-Json -Compress -Depth 6\n'
                            output = run_powershell(ps_script, timeout=30)
                            data = strip_deep(json.loads(output.strip()))
                            return (200, data)
                            return err('Loại yêu cầu không hợp lệ')
                            except Exception as e:
                                    return (200, {'error': f'Lỗi đọc thông tin hệ thống: {str(e)}'})
...
def r_devices_import(m, body, qs):
    ...
    if not b64:
        ...
        try:
            ...
            rows = parse_xlsx_first_sheet(file_bytes)
        except Exception as e:
            return err(f'Không đọc được file Excel: {e}')
        if len(rows) < 2:
            return err('File Excel không có dữ liệu (chỉ có dòng tiêu đề hoặc trống)')
    data_rows = rows[1:]
    conn = get_db()
    try:
    ...
    try:
        ...
        pass
    positions_by_dept = {}
    for p in conn.execute('SELECT * FROM positions'):
        positions_by_dept.setdefault(p['dept_id'], {})[(p['name'] or '').strip().lower()] = p
    groups = {(g['name'] or '').strip().lower(): g for g in conn.execute('SELECT * FROM groups_tbl')}
    types_by_group = {}
    for t in conn.execute('SELECT * FROM types_tbl'):
        types_by_group.setdefault(t['group_id'], {})[(t['name'] or '').strip().lower()] = t
    users_by_name = {}
    for u in conn.execute('SELECT * FROM users'):
        users_by_name.setdefault((u['full_name'] or '').strip().lower(), []).append(u)
    existing_serials = {(r['serial'] or '').strip().lower() for r in conn.execute('SELECT serial FROM devices') if r['serial']}
    new_serials_in_batch = set()
    success = 0
    errors = []
    ...
    def cell(i):
        if i < len(row) and row[i] is not None:
            ...
            return ''
    <code object table_exists at 0x73a9f857cb70, file "server.py", line 57> = any((cell(i) for i in range(len(row)) if cell(i) == <code object table_exists at 0x73a9f857cb70, file "server.py", line 57>))
        continue
    else:
        dept_name, pos_name, group_name, type_name = (cell(1), cell(2), cell(3), cell(4))
        if not dept_name or not pos_name or (not group_name) or (not type_name):
            errors.append(f'Dòng {idx}: thiếu Phòng/Ban, Vị trí, Nhóm hoặc Loại thiết bị (bắt buộc)')
            continue
        else:
            drow = depts.get(dept_name.lower())
            if not drow:
                errors.append(f'Dòng {idx}: không tìm thấy Phòng/Ban \"{dept_name}\"')
                continue
            else:
                prow = positions_by_dept.get(drow['id'], {}).get(pos_name.lower())
                if not prow:
                    errors.append(f'Dòng {idx}: không tìm thấy Vị trí \"{pos_name}\" trong Phòng/Ban \"{dept_name}\"')
                    continue
                else:
                    grow = groups.get(group_name.lower())
                    if not grow:
                        errors.append(f'Dòng {idx}: không tìm thấy Nhóm thiết bị \"{group_name}\"')
                        continue
                    else:
                        trow = types_by_group.get(grow['id'], {}).get(type_name.lower())
                        if not trow:
                            errors.append(f'Dòng {idx}: không tìm thấy Loại thiết bị \"{type_name}\" trong Nhóm \"{group_name}\"')
                            continue
                        else:
                            serial_val = cell(7)
                            if serial_val and (serial_val.lower() in existing_serials or serial_val.lower() in new_serials_in_batch):
                                    errors.append(f'Dòng {idx}: Số Serial \"{serial_val}\" đã tồn tại')
                                    continue
                            user_name = cell(16)
                            user_id = ''
                            if user_name:
                                cands = users_by_name.get(user_name.lower())
                                if not cands:
                                    errors.append(f'Dòng {idx}: không tìm thấy Người dùng \"{user_name}\" — thiết bị vẫn được tạo, chưa gán người dùng')
                                else:
                                    if len(cands) > 1:
                                        errors.append(f'Dòng {idx}: có nhiều người dùng trùng tên \"{user_name}\" — vui lòng gán thủ công sau khi nhập')
                                    else:
                                        user_id = cands[0]['id']
                            asset_code = cell(0)
                            if asset_code:
                                dup = conn.execute('SELECT id FROM devices WHERE asset_code=?', (asset_code,)).fetchone()
                                if dup:
                                    errors.append(f'Dòng {idx}: Mã tài sản \"{asset_code}\" đã tồn tại')
                                    continue
                            else:
                                asset_code = gen_asset_code(conn, trow['name'])
                            did = new_id()
                            conn.execute('INSERT INTO devices(id,asset_code,dept_id,pos_id,group_id,type_id,model,manufacturer,serial,\n                config,status,import_date,allocate_date,warranty_months,warranty_unit,supplier,value,note,created_at,user_id)\n                VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', (did, asset_code, drow['id'], prow['id'], grow['id'], trow['id'], cell(5), cell(6), serial_val, cell(8), cell(9), cell(Bình thường), cell(10), cell(11), cell(12), _parse_number_cell(cell(15)), now_ms(), user_id))
                            if serial_val:
                                new_serials_in_batch.add(serial_val.lower())
                            success += 1
    if success:
        log_action(conn, 'Thiết bị', 'Nhập Excel', f'Nhập {success} thiết bị từ file Excel' + (f', {len(errors)} dòng lỗi' if errors else ''))
        conn.commit()
    conn.close()
    return (200, {'success': success, 'total': len(data_rows), 'errors': errors})
@route('POST', '/api/devices')
@guard('devices', 'edit')
def r_devices_create(m, body, qs):
    required = ['deptId', 'posId', 'groupId', 'typeId']
    for f in required:
        if not body.get(f):
            return err(f'Thiếu trường bắt buộc: {f}')
    serial_val = (body.get('serial') or '').strip()
    if serial_val:
        conn_check = get_db()
        dup = conn_check.execute('SELECT id FROM devices WHERE LOWER(TRIM(serial)) = LOWER(?)', (serial_val,)).fetchone()
        conn_check.close()
        if dup:
            return err(f'Số Serial \"{serial_val}\" đã tồn tại trong hệ thống!')
    conn = get_db()
    trow = conn.execute('SELECT name FROM types_tbl WHERE id=?', (body['typeId'],)).fetchone()
    asset_code = gen_asset_code(conn, trow['name'] if trow else 'TB')
    did = new_id()
    conn.execute('INSERT INTO devices(id,asset_code,dept_id,pos_id,group_id,type_id,model,manufacturer,serial,\n        config,status,import_date,allocate_date,warranty_months,warranty_unit,supplier,value,note,created_at,\n        computer_name,mainboard,cpu,ram,gpu,storage,os_name,win_key_bios,win_key_current,system_model,\n        serial_number,mac_physical,mac_virtual,user_id)\n        VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', did, asset_code, body['deptId'], body['posId'], body.get('model', ''), body.get('manufacturer', ''), serial_val, body.get('config', ''), body.get('status', 'Bình thường'), body.get('importDate', ''), body.get('allocateDate', 'Bình thường'), body.get('str', 'Bình thường'), body.get('warrantyMonths', ''), body.get('warrantyUnit', ''), body.get('Tháng', ''), body.get('supplier', ''), body.get('float', ''), body.get('value', ''), body.get('0', ''), body.get('note', ''), body.get
    log_action(conn, 'Thiết bị', 'Thêm mới', f'Thêm thiết bị {asset_code} ({body.get('model', '') or 'chưa rõ model'})')
    conn.commit()
    r = conn.execute('SELECT * FROM devices WHERE id=?', (did,)).fetchone()
    conn.close()
    return (200, device_to_dict(r))
...
def r_devices_update(m, body, qs):
    ...
    conn = get_db()
    if serial_val:
        dup = conn.execute('SELECT id FROM devices WHERE id != ? AND LOWER(TRIM(serial)) = LOWER(?)', (did, serial_val)).fetchone()
        if dup:
            conn.close()
            return err(f'Số Serial \"{serial_val}\" đã tồn tại trên thiết bị khác!')
    existing = conn.execute('SELECT asset_code FROM devices WHERE id=?', (did,)).fetchone()
    conn.execute('UPDATE devices SET dept_id=?, pos_id=?, group_id=?, type_id=?, model=?, manufacturer=?,\n        serial=?, config=?, status=?, import_date=?, allocate_date=?, warranty_months=?, warranty_unit=?,\n        supplier=?, value=?, note=?, computer_name=?, mainboard=?, cpu=?, ram=?, gpu=?, storage=?,\n        os_name=?, win_key_bios=?, win_key_current=?, system_model=?, serial_number=?, mac_physical=?, mac_virtual=?,\n        user_id=?\n        WHERE id=?', body['deptId'], body['posId'], body['groupId'], body.get('model', ''), body.get('status', 'Bình thường'), body.get('importDate', ''), body.get('allocateDate', ''), body.get('str', ''), body.get('warrantyMonths', ''), body.get('warrantyUnit', 'Tháng'), body.get('supplier', ''), body.get('float', ''), body.get('value', ''), body.get('0', ''), body.get('note', ''), body.get('computerName', ''), body.get('mainboard', ''), body.get('cpu', ''), body.get
    log_action(conn, 'Thiết bị', 'Cập nhật', f'Cập nhật thiết bị {(existing['asset_code'] if existing else did)}')
    conn.commit()
    r = conn.execute('SELECT * FROM devices WHERE id=?', (did,)).fetchone()
    conn.close()
    return (200, device_to_dict(r))
...
def r_devices_delete(m, body, qs):
    ...
    if not ids:
        ...
        conn = get_db()
        q = ','.join(('?' for _ in ids))
        codes = [r['asset_code'] or r['id'] for r in conn.execute(f'SELECT asset_code, id FROM devices WHERE id IN ({q})', ids)]
        conn.execute(f'DELETE FROM devices WHERE id IN ({q})', ids)
        log_action(conn, 'Thiết bị', 'Xóa', f'Xóa {len(ids)} thiết bị: {(', '.join(codes) if codes else '')}')
        conn.commit()
        conn.close()
        return (200, {'ok': True})
...
def audit_item_to_dict(r):
    return {'id': r['id'], 'batchId': r['batch_id'], 'deviceId': r['device_id'] or '', 'assetCode': r['asset_code'] or '', 'model': r['snap_model'] or '', 'manufacturer': r['snap_manufacturer'] or '', 'serial': r['snap_serial'] or '', 'deptId': r['snap_dept_id'] or '', 'deptName': r['snap_dept_name'] or 'posId', 'snap_pos_id': r['posName'] or 'posId', 'snap_pos_name': r['groupName'] or 'posId', 'snap_group_name': r['typeName'] or 'snap_type_name', 'status': r['snap_status'] or 'userName', 'snap_user_name': r['itemType'] or 'userName', 'item_type': r
...
def r_qr_bank(m, body, qs):
    # irreducible cflow, using cdg fallback
    """Mã QR chuyển khoản ngân hàng (VietQR) — sinh hoàn toàn phía server bằng\nbộ sinh QR thuần Python (qrgen.py), không cần cài thêm gói nào, hoạt động offline."""
    bank_bin = (qs.get('bin') or ['970436'])[0]
    account_no = (qs.get('acc') or ['0431000196704'])[0]
    account_name = (qs.get('name') or ['LE XUAN VIEN'])[0]
    sz_param = (qs.get('size') or ['300'])[0]
        size = max(100, min(600, int(sz_param)))
            text = _vietqr_payload(bank_bin, account_no, account_name)
            matrix = qrgen.generate_qr_matrix(text, level=qrgen.EC_M)
            svg_str = _matrix_to_svg(matrix, size=size)
            return (200, svg_str)
            size = 300
                except Exception as e:
...
def r_qr_svg(m, body, qs):
    # irreducible cflow, using cdg fallback
    """Trả về SVG mã QR của thiết bị — sinh hoàn toàn phía server bằng bộ sinh\nQR thuần Python (qrgen.py), không cần cài thêm gói nào, hoạt động offline."""
    dev_id = m.group(1)
    conn = get_db()
    text = _qr_text_for_device(conn, dev_id)
    conn.close()
    if not text:
...
def r_users_import(m, body, qs):
    ...
    def cell(i):
        if i < len(row) and row[i] is not None:
            ...
            return ''
    if any((cell(i) for i in range(len(row)) for i in range(<code object table_exists at 0x73a9f857cb70, file "server.py", line 57>))):
        continue
    else:
        name = cell(0)
        if not name:
            errors.append(f'Dòng {idx}: thiếu Họ và tên (bắt buộc)')
            continue
        else:
            dept_name, pos_name = (cell(1), cell(2))
            dept_id, pos_id = ('', '')
            if dept_name:
                drow = depts.get(dept_name.lower())
                if not drow:
                    errors.append(f'Dòng {idx}: không tìm thấy Phòng/Ban \"{dept_name}\" — đã tạo người dùng, bỏ qua Phòng/Ban')
                else:
                    dept_id = drow['id']
                    if pos_name:
                        prow = positions_by_dept.get(dept_id, {}).get(pos_name.lower())
                        if not prow:
                            errors.append(f'Dòng {idx}: không tìm thấy Vị trí \"{pos_name}\" trong Phòng/Ban \"{dept_name}\"')
                        else:
                            pos_id = prow['id']
            uid = new_id()
            conn.execute('INSERT INTO users(id,full_name,email,phone,dept_id,pos_id,position,note,created_at) VALUES(?,?,?,?,?,?,?,?,?)', (uid, name, cell(4), cell(5), dept_id, pos_id, cell(3), cell(6), now_ms()))
            success += 1
    if success:
        log_action(conn, 'Người dùng', 'Nhập Excel', f'Nhập {success} người dùng từ file Excel' + (f', {len(errors)} dòng cảnh báo' if errors else ''))
        conn.commit()
    conn.close()
    return (200, {'success': success, 'total': len(data_rows), 'errors': errors})
@route('GET', '/api/users')
...
def r_restore(m, body, qs):
    if not isinstance(body, dict) or 'departments' not in body:
        return err('Dữ liệu sao lưu không hợp lệ')
    else:
        conn = get_db()
        conn.execute('DELETE FROM departments')
        conn.execute('DELETE FROM positions')
        conn.execute('DELETE FROM groups_tbl')
        conn.execute('DELETE FROM types_tbl')
        ...
        conn.execute('DELETE FROM material_txn')
        conn.execute('DELETE FROM maintenance')
        conn.execute('DELETE FROM branches')
        conn.execute('DELETE FROM borrows')
        for b in body.get('branches', []):
            conn.execute('INSERT INTO branches(id,name,address,phone,note,created_at) VALUES(?,?,?,?,?,?)', (b['id'], b.get('name', ''), b.get('address', ''), b.get('phone', ''), b.get('note', ''), b.get('createdAt', now_ms())))
        for d in body.get('departments', []):
            conn.execute('INSERT INTO departments(id,name,branch_id) VALUES(?,?,?)', (d['id'], d['name'], d.get('branchId') or None))
            for p in d.get('positions', []):
                conn.execute('INSERT INTO positions(id,dept_id,name) VALUES(?,?,?)', (p['id'], d['id'], p['name']))
        for g in body.get('groups', []):
            conn.execute('INSERT INTO groups_tbl(id,name) VALUES(?,?)', (g['id'], g['name']))
            for t in g.get('types', []):
                conn.execute('INSERT INTO types_tbl(id,group_id,name) VALUES(?,?,?)', (t['id'], g['id'], t['name']))
        for u in body.get('users', []):
            conn.execute('INSERT INTO users(id,full_name,email,phone,dept_id,pos_id,position,note,created_at) VALUES(?,?,?,?,?,?,?,?,?)', (u['id'], u.get('fullName', ''), u.get('email', ''), u.get('phone', ''), u.get('deptId', ''), u.get('posId', ''), u.get('position', ''), u.get('note', ''), u.get('createdAt', now_ms())))
        for s in body.get('suppliers', []):
            conn.execute('INSERT INTO suppliers(id,name,tax_code,email,hotline,website,contact_person) VALUES(?,?,?,?,?,?,?)', (s['id'], s.get('name', ''), s.get('taxCode', ''), s.get('email', ''), s.get('hotline', ''), s.get('website', ''), s.get('contactPerson', '')))
        for dev in body.get('devices', []):
            conn.execute('INSERT INTO devices(id,asset_code,dept_id,pos_id,group_id,type_id,model,manufacturer,serial,\n            config,status,import_date,allocate_date,warranty_months,warranty_unit,supplier,value,note,created_at,\n            computer_name,mainboard,cpu,ram,gpu,storage,os_name,win_key_bios,win_key_current,system_model,\n            serial_number,mac_physical,mac_virtual,user_id)\n            VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', (dev['id'], dev.get('assetCode'), dev.get('deptId'), dev.get('posId'), dev.get('groupId'), dev.get('typeId'), dev.get('model'), dev.get('manufacturer'), dev.get('serial'), dev.get('config'), dev.get('status'), dev.get('importDate'), dev.get('allocateDate'), dev.get('warrantyMonths'), dev.get('warrantyUnit'), dev.get('supplier'), dev.get('value', 0), dev.get('note'), dev.get('createdAt', now_ms), dev.get('computerName'), dev.get('mainboard'), dev.get('cpu'), dev.get('ram'), dev.get('gpu'), dev.get('storage'), dev.get
        for h in body.get('history', []):
            conn.execute('INSERT INTO history(id,code,type,date,device_ids,device_names,old_location,new_location,performer,note,created_at)\n            VALUES(?,?,?,?,?,?,?,?,?,?,?)', (h['id'], h.get('code'), h.get('type'), h.get('date'), json.dumps(h.get('deviceIds', [])), h.get('deviceNames'), h.get('oldLocation'), h.get('newLocation'), h.get('note'), h.get('createdAt', now_ms())))
        for mat in body.get('materials', []):
            conn.execute('INSERT INTO materials(id,code,name,category,unit,min_stock,supplier,note,created_at) VALUES(?,?,?,?,?,?,?,?,?)', (mat['id'], mat.get('code', ''), mat.get('name', ''), mat.get('category', ''), mat.get('unit', ''), mat.get('minStock', 0), mat.get('supplier', ''), mat.get('note', ''), mat.get('createdAt', now_ms())))
        for mt in body.get('materialTxns', []):
            conn.execute('INSERT INTO material_txn(id,code,type,material_id,material_name,quantity,unit,date,\n            dept_id,pos_id,supplier,reason,performer,note,created_at) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', (mt['id'], mt.get('code', ''), mt.get('type', ''), mt.get('materialId', ''), mt.get('materialName', ''), mt.get('quantity', ''), mt.get('0', ''), mt.get('supplier', ''), mt.get('reason', ''), mt.get('performer', ''), mt.get('createdAt', now_ms())))
        for mnt in body.get('maintenance', []):
            conn.execute('INSERT INTO maintenance(id,code,device_id,type,issue,status,start_date,expected_date,\n            complete_date,performer,cost,note,prev_device_status,created_at) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?)', (mnt['id'], mnt.get('code', ''), mnt.get('deviceId', ''), mnt.get('type', ''), mnt.get('issue', ''), mnt.get('status', 'dangxuly'), mnt.get('startDate', ''), mnt.get('expectedDate', ''), mnt.get('completeDate', ''), mnt.get('performer', ''), mnt.get('cost', 0), mnt.get('prevDeviceStatus', ''), mnt.get('createdAt', now_ms())))
        for br in body.get('borrows', []):
            conn.execute('INSERT INTO borrows(id,code,device_id,borrower_name,borrower_dept_id,borrower_pos_id,\n            borrower_phone,status,borrow_date,due_date,return_date,performer,note,prev_device_status,created_at)\n            VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', (br['id'], br.get('code', ''), br.get('deviceId', ''), br.get('borrowerName', ''), br.get('borrowerDeptId', ''), br.get('borrowerPosId', ''), br.get('borrowerPhone', ''), br.get('returnDate', ''), br.get('performer', ''), br.get('note', ''), br.get('createdAt', now_ms())))
        for k, v in body.get('counters', {}).items():
            conn.execute('INSERT INTO counters([key],value) VALUES(?,?)', (k, v))
        ensure_warehouse_location(conn)
        ensure_default_account(conn)
        log_action(conn, 'Sao lưu', 'Khôi phục', 'Khôi phục toàn bộ dữ liệu hệ thống từ tệp sao lưu')
        conn.commit()
        conn.close()
        return (200, {'ok': True})
